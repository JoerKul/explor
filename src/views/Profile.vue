      ...
      <div class="col-lg-3 col-md-4 col-sm-4">
        <div class="main-box clearfix">
          ...
          <div class="profile-stars">
            ...
            <span class="px-2">Super User</span>
          </div>
          ...
          <div class="profile-details">
            <ul class="fa-ul">
              <li><i class="fa-li fa fa-truck"></i>Orders: <span>4</span></li>
              <li><i class="fa-li fa fa-comment"></i>Posts: <span>28</span></li>
              <li>
                <i class="fa-li fa fa-tasks"></i>Tasks done: <span>14</span>
              </li>
            </ul>
          </div>
        ...
        <div class="main-box clearfix">
            ...
            <div class="col-sm-4 profile-social">
              <ul class="fa-ul">
                <li>
                  ...
                  ><a class="linkcolor" href="#">@joekul</a>
                </li>
                <li>
                  <i class="fa-li fab fa-linkedin"></i
                  ><a class="linkcolor" href="#">Jörg </a>
                </li>
                <li>
          ...
          <div class="tabs-wrapper profile-tabs">
            <ul class="nav nav-tabs">
              <li>
                <a class="linkcolor" href="#tab-activity" data-toggle="tab"
                  >Activity</a
                >
              </li>
              <li>
                <a class="linkcolor" href="#tab-friends" data-toggle="tab"
                  >Friends</a
                >
              </li>
              <li>
                <a class="linkcolor" href="#tab-chat" data-toggle="tab">Chat</a>
              </li>
            </ul>
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          Jörg posted a comment in
                          <a href="#">React for beginners</a> workshop.
                        </td>
                        <td>
                          2020/05/12 14:12
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          Jörg changed workshop progress from
                          <span class="label label-primary">waiting</span> to
                      ...
                      <tr>
                        ...
                        <td>
                          Jörg changed order status from
                  ...
                  >
                    ...
                    <div class="details">
                      ...
                      <div class="time">
                        ...
                        {{ randomMinute() }} minutes ago
                      </div>
                      <div class="type">
                        <span class="label label-danger">Registered User</span>
                      </div>
                    </div>
                  </li>
                </ul>
                      ...
                      >
                        <div class="conversation-item item-left clearfix">
                          ...
                          <div class="conversation-body">
                            ...
                            <div class="text">
                              What do you think about the new workshop about the
                        ...
                        <div class="conversation-item item-right clearfix">
                          ...
                          <div class="conversation-body">
                            ...
                            <div class="text">
                              I am excited, the content can definitely be
                              shortened a bit. So we could offer a second
                              course, which builds on the first one.
                            </div>
                          </div>
                        </div>
                        <div class="conversation-item item-right clearfix">
                          ...
                          <div class="conversation-body">
                            ...
                            <div class="text">
                              There could then be a series of workshops,
                              starting from a beginner level up to expert. This
                              would also give us a broader target group and we
                              could start the workshops in parallel.
                            </div>
                          </div>
                        </div>
                        <div class="conversation-item item-left clearfix">
                          ...
                          <div class="conversation-body">
                            ...
                            <div class="text">
                              Good ideas, I want to discuss the matter with our
                              trainers. I'll get back to you when I know more.
                            </div>
                          </div>
                        </div>
                      </div>
